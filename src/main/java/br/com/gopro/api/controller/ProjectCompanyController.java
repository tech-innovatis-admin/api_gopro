...
@RestController
@RequestMapping("/project-companies")
@RequiredArgsConstructor
@Tag(name = "ProjectCompanies", description = "Gerenciamento de vinculos projeto-empresa")
public class ProjectCompanyController {

    private final ProjectCompanyService projectCompanyService;

    @Operation(summary = "Criar vinculo projeto-empresa")
    @ApiResponses({
    ...
    @Operation(summary = "Listar vinculos projeto-empresa")
    @ApiResponses({
